...
public interface ServerInterface extends Remote {
	...
	// */
	// public Integer clientConnect(ClientInterface paramClient) throws
	// RemoteException;

	// public void clientDisconnect(ClientInterface paramClient) throws
	// RemoteException;
	//
	// /**
	...
	//
	// public Vector<ClientInterface> getRequest(ResourceInterface
	// paramResource) throws RemoteException;
