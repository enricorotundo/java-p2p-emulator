...
public final class Server implements ServerInterface {
	...
	// private Vector<ClientInterface> myConnectedClients = new
	// Vector<ClientInterface>();
	...
	//
	// // @Override
	// // public Integer clientConnect(final ClientInterface paramClient) throws
	// // RemoteException {
	// // if (myConnectedClients.contains(paramClient)) {
	// // System.out.println("Client " + paramClient.getClientName() +
	// // " already connected!");
	// // return 0;
	// // } else {
