...
start:
	...
	sleep 4
	xterm $(XTERM) -e "cd bin/ && java starter.ClientStarter C1 Razorback1 3 A 1 B 4 C 6; read"  &
	xterm $(XTERM) -e "cd bin/ && java starter.ClientStarter C2 Razorback2 3 A 1 D 2; read"  &
