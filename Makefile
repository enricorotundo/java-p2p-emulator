...
progetto:
	javac -Xlint:unchecked ./src/controller/client/Client.java ./src/controller/server/ClientChecker.java ./src/controller/client/ConnectionChecker.java ./src/controller/client/ClientInterface.java ./src/controller/server/ServerChecker.java ./src/controller/server/Server.java ./src/controller/server/ServerInterface.java ./src/model/client/ClientResources.java ./src/model/server/ConnectedClients.java ./src/model/server/ConnectedServers.java ./src/model/share/Resource.java ./src/starter/ClientStarter.java ./src/starter/ServerStarter.java ./src/view/AbstractBasicFrame.java ./src/view/ClientFrame.java ./src/view/ServerFrame.java -d ./bin
